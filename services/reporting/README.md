...
Read-only projections for administration and audit search.

Owns `projections,consumer_checkpoints,audit_projections`. Database: `cw_reporting`. No other service may read or write these tables.
