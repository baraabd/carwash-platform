...
Notifications, delivery attempts, booking conversations and realtime.

Owns `notifications,delivery_attempts,conversations,messages`. Database: `cw_communications`. No other service may read or write these tables.
