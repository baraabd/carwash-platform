...
Authentication, sessions, roles and grants.

Owns `users,credentials,sessions,roles,permissions`. Database: `cw_identity`. No other service may read or write these tables.
