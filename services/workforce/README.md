...
Operators, teams, vans, onboarding and verification decisions.

Owns `operators,teams,vans,equipment,verification_cases,work_grants`. Database: `cw_workforce`. No other service may read or write these tables.
