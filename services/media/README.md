...
Classified objects, quarantine, scans, retention and audited access.

Owns `objects,upload_reservations,scan_jobs,retention_jobs`. Database: `cw_media`. No other service may read or write these tables.
